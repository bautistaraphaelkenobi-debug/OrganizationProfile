...
namespace AccountRegistration
{
    ...
    {
        string connectionString = "Server=DESKTOP-PETL4CO\\SQLEXPRESS;Database=NINE;Trusted_Connection=True;";
        ...
        public int Age(string age)
        {
            try
            {
                ...
                {
                    throw new FormatException("Age must be a number between 1 and 99.");
                }
            }
            catch (FormatException ex)
            {
